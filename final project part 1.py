class QuizMaker:
    ...
    def __init__(self):
        """initialize the quizmaker class."""
        self.questions = [
    ...
    def get_info(self):
        ...
        attempts = 0
        while attempts < 3:
            self.student_id = input("Enter your student ID (format: A12345): ")
            if self.student_id.startswith('A') and self.student_id[1:].isdigit() and len(self.student_id) == 6:
    ...
    def save_results(self):
        ...
        filename = self.student_id + ".txt"
        with open(filename, "w") as file:
            file.write("Student ID: " + self.student_id + "\n")
            file.write("First name: " + self.first_name + "\n")
            file.write("Score: " + str(self.score) + "/10\n")
